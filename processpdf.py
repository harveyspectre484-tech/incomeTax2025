...
for num in list2:
    input = fr"C:\Users\10459\Desktop\rag\incomeTax2025\jsonadobe\{num}section.json"

    output = fr"C:\Users\10459\Desktop\rag\incomeTax2025\referencejson\{num}section.json"

    subprocess.run(["python",r"C:\Users\10459\Desktop\rag\incomeTax2025\enrich_reference.py",input, "-o", output]) 
